# System Context -- career-ops-reiterated
...
<!-- ============================================================
     ...
     that improve with each career-ops-reiterated release.
     ============================================================ -->
...
| Level fit | Seniority match (staff+, senior, mid-senior, mid, junior) |
| Cultural signals | Company culture, growth, stability, remote policy |
| Red flags | Blockers, warnings (negative adjustments) |
| **Global** | Weighted average of above |

> **Note:** Compensation is NOT a scoring dimension. It is researched in Block D as a standalone reference to inform negotiation — not to inflate or deflate the match score. The score reflects fit; Block D tells you what to ask for.
