...
| Metrics potential | 15% | Clear metrics (latency, cost, accuracy) | No measurable outcome |
| Time to MVP | 10% | 1 week | 3+ months |
| STAR story potential | 10% | Rich story with trade-offs | Purely implementation |
...
- **PIVOT TO [alternative]** → more impactful variant of the idea
